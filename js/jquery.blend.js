...
(function($){
    ...
    */
	...
	var settings = $.extend({}, $.fn.blend.settings, options);
		...
		style.width += parseInt($target.css("padding-left"), 10) + parseInt($target.css("padding-right"), 10);
		style.width += parseInt($target.css("margin-left"), 10) + parseInt($target.css("margin-right"), 10);
		style.width += parseInt($target.css("borderLeftWidth"), 10) + parseInt($target.css("borderRightWidth"), 10);
		
		//style.height=$target.css('height');
		style.height=$target.height();
		style.height += parseInt($target.css("padding-top"), 10) + parseInt($target.css("padding-bottom"), 10);
		//style.height += parseInt($target.css("margin-top"), 10) + parseInt($target.css("margin-bottom"), 10);
		//style.height += parseInt($target.css("borderTopWidth"), 10) + parseInt($target.css("borderBottomWidth"), 10);
